...
client.on('message', async (message) => {
    if (message.content.startsWith('.yardım')) {
        ...
        .setLabel('Support')
        .setID('buton2')
        //.setURL('https://l24.im/BhxO5')
        
        let button3 = new disbut.MessageButton()
        .setStyle('url')
        .setLabel('Davet')
        .setURL('https://discord.com/oauth2/authorize?client_id=951549636957593700&scope=bot&permissions=27648860222')
        
        let button4 = new disbut.MessageButton()
        .setStyle('url')
        .setLabel('YouTube')
        .setURL('https://www.youtube.com/c/ZewoYT')
...
message.channel.send(`Merhaba ${message.author} **Lucifero Yardım Menüsüne Hoş Geldin** | Aşağıdan Seçim Yapabilirsin.`, {
  buttons:[
...
client.on('clickButton', async (button, message) => {
  ...
  */
  ...
  /*if (button.id === 'buton3()') {
      button.channel.send(`||https://www.youtube.com/c/ZewoYT||`)
  }*/
});
...
return message.channel.send(`**${message.author}, <@571327787856822295>'in Botuna Hoş Geldin | Aşağıdan Kanala Ulaşabilirsin.**`, {
  buttons:[
                button,
